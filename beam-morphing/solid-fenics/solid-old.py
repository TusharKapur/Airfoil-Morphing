...
def neumann_boundary(x, on_boundary):
    ...
    """
    return on_boundary and ((abs(x[1]) < tol) or ((x[0] - 4.0) < tol) or ((x[1] - 1.0) < tol))
...
bc1 = DirichletBC(V, Constant((0, 0)), fd, 1)
...
while precice.is_coupling_ongoing():
    ...
    #!!!!!!!!!!!!!!!!!!!!!!!!!!!
    read_data[(3.898632503682673, 0.8975168590179845)][1] += -10000.0
    # print(read_data)
    ...
    # !!!!!!!!!!!!!!!!!1
    # Applying point load
    # point_force = PointSource(V, Point(3.0, 1.0,), -100.0)
    # point_force.apply(b)

    # f0 = PointLoad(pt=(3.0, 1.0,), vl=(0.0, -100.0), tol=1e-1,degree = 1)
