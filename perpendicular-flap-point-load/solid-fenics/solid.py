...
# !!!!!!!!!!!!!
# Point to define displacement (Dirichlet BC)
# def forcing_boundary(x, on_boundary):
#     return on_boundary and abs(x[1] - H/2) < tol
forcing_boundary = CompiledSubDomain("near(x[0], -0.05) && near(x[1], 1.0) ")
...
# !!!!!!!!!!!!!!!!!!!
# New boundary
# point_force_boundary = AutoSubDomain(forcing_boundary)
...
# !!!!!!!!!!!!!!!111!111
# New boundary
bc2 = DirichletBC(V.sub(0), Constant((0.0)), forcing_boundary, method = "pointwise")
